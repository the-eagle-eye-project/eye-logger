...
@RestController
@RequestMapping(value = "/eye/logger")
...
public class EyeLoggerController {
    ...
    @PostMapping
    public ResponseEntity<EyeLoggerServiceResponse> createLog(@RequestHeader HttpHeaders headers, @RequestBody EyeLoggerServiceRequest eyeLoggerServiceRequest) {
